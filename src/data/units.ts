...
export const UNITS: UnitDef[] = [
  ...
  // ===== 히든 (hidden) =====
  {
    ...
    skills: [{
      ...
      id: "sk_singularity_summon", name: "그림자 소환", icon: "summon",
      trigger: { kind: "timer", everySeconds: 12 }, target: "self",
      effects: [{ type: "summon", defId: "rift_eye", count: 2, lifeSeconds: 8 }],
      desc: "12초마다 그림자 정찰병 2기를 소환한다(8초).",
    }],
  },
  {
