...
yarn browser-direct --seeds=6 --json=output/browser-direct.json --screenshots=output/browser-direct-shots
                          # 실행 중인 yarn dev 서버에서 실제 소환/합성/조합/업그레이드 입력 흐름으로 6시드 이상 긴 밸런스 표본 수집
