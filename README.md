...
yarn balance-proof        # 자동/브라우저 밸런스 증거 JSON, 스크린샷, Codex 보조 로그, 감사표, 수동 플레이 시트를 갱신
