...
- Tuned difficulty HP/economy/unit-cap/enemy-limit values and late-grade unit stats using automated play matrices:
  - Beginner clears with hero-and-below only: 20/20 clears.
  - Normal needs legend help: 0 legends 2/20 clears, 2 legends 8/20 clears.
  - Intermediate rejects low legend counts but clears with enough scaling: 2 legends 3/20 clears, 5 legends 10/20 clears, unrestricted average 15.1 legends 20/20 clears.
  - Expert needs more than the intermediate legend budget: 5 legends 0/20 clears, unrestricted average 13.3 legends 13/20 clears.
  - Master is intentionally severe in balanced autoplay: unrestricted 0/20 clears.
...
- Added `yarn balance --seeds=20` as a repeatable five-difficulty balance gate matching the current target bands.
